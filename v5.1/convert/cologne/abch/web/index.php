...
<body>
   <table width="100%"> 
     <tr><td width="10%">
      ...
      <td><span id="title">Abhidhānacintāmaṇi of Hemacandrācārya</span></td>
      </tr>
    </table>
...
$href_fm_cologne="//www.sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/abch.html";
if ($dictinfowhich == "cologne") {
 ...
 if ( is_dir($testpath)) {
  ...
  $href_fm = "$testpath/build/dictionaries/abch.html";
 } else {
...
?>
  ...
  <li><a href="abchheader.xml">License of Digital Edition</a></li>
  <li><a href="https://www.worldcat.org/title/Abhidhānacintāmaṇi of Hemacandrācārya">WorldCat reference</a></li>
  <li>Bibliographic entry: Abhidhānacintāmaṇi of Hemacandrācārya</li>
 </ol>
